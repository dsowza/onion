...
<html>
    ...
    <body>
        ...
        <div id="show-parametro" class="content scaffold-show" role="main">
            ...
            <f:display bean="parametro" />
            <g:form resource="${this.parametro}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.parametro}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
