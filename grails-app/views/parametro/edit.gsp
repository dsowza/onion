...
<html>
    ...
    <body>
        ...
        <div id="edit-parametro" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.parametro}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.parametro}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.parametro}" method="PUT">
                <g:hiddenField name="version" value="${this.parametro?.version}" />
                <fieldset class="form">
                    <f:all bean="parametro"/>
                </fieldset>
