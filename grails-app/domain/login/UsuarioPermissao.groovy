...
class UsuarioPermissao implements Serializable {
	...
	static UsuarioPermissao create(Usuario usuario, Permissao permissao) {
	...
	static int removeAll(Usuario u) {
		u == null ? 0 : UsuarioPermissao.where { usuario == u }.deleteAll()
	}

	static int removeAll(Permissao r) {
		r == null ? 0 : UsuarioPermissao.where { permissao == r }.deleteAll()
	}
